...
5. **Fix organize task invocation**
   - Patch `cli.py` as above to remove positional arg mismatch
   - Refactor `organize_structure.main()` to accept explicit params
   - Add argument validation + success exit code
