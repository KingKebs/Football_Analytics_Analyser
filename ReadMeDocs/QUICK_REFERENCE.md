...
# Parsed fixture corner predictions (today's fixtures)
python cli.py --task corners --league E0,SP1 --use-parsed-all --top-n 5
# Specific fixture date
python cli.py --task corners --league E0,SP1 --use-parsed-all --fixtures-date 20251121 --min-team-matches 5
# Single match corner projection
python cli.py --task corners --league E0 --home-team Arsenal --away-team Chelsea
```
